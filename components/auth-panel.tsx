    ...
    try {
      if (isSignup) {
        const { data, error: signUpError } = await supabaseBrowser.auth.signUp({
          ...
          password,
          options: {
            data: { forwarder_name: company.trim() },
        ...
        if (data.session) {
          // Email confirmations are disabled — straight to the dashboard.
          router.push(nextPath);
          router.refresh();
          return;
        }

        // A verification email was sent; show the confirmation state. The
        // forwarders row is created by the database trigger at signup time.
    ...
    <div className="fn-shell">
      ...
      <div className="auth-main">
        <div className="auth-box">
          ...
          {needsVerification ? (
            <div className="fn-banner-success">
              <p className="fn-success-head">Check your inbox</p>
              <p className="mt-1">
                We sent a confirmation link to <b>{email}</b>. Click it to verify your account, then log in.
              </p>
            </div>
          ) : (
            <>
              <div className="auth-social">
                <button type="button" className="fn-btn-ghost" disabled title="OAuth sign-in is coming soon — use email instead.">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="fn-field">
                  <div className="fn-field-head">
                    ...
                    {!isSignup && <span className="auth-forgot">Forgot password?</span>}
                  </div>
                  <input
                    id="password"
                    name="password"
                ...
                <button type="submit" className="cta fn-cta-block" disabled={busy}>
